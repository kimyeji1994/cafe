...
<!-- <form id="writeForm"> -->	
	<form class="form-horizontal" role="form" id="writeForm" method="post" action="">
   	...
   	<div class="form-group required">
		...
		<div class="form-group required">
			<div class="input-group col-md-3 date input-append date" id="dpDOB">
		...
		<div class="form-group required">
			<div class="input-group col-md-3 date input-append date" id="dpDOB2">
				<span class="input-group-addon add-on">
				<span class="glyphicon glyphicon-calendar"></span></span>
		...
		<div class="form-group required">		
			...
			<button type="button" class="btn btn-default btn-sm" id="complex">Complex</button>		
		</div>
